...
const Load: React.FC<LoadProps> = ({ className }) => {
  const combinedClassName = `animate-spin ${className ? ` ${className}` : 'w-6 h-6 fill-white'}`;

  return (
    <svg className={combinedClassName} viewBox="3 3 18 18">
