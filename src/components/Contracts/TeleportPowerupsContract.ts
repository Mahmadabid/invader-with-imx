...
export const teleportContractURI = 'https://blush-accepted-turkey-504.mypinata.cloud/ipfs/QmTApmyZ5TrUeCMhpHAAr6g6tJWHcCknsNp8A4x63VHb4D/';

export const newTeleportBaseURI = '';

export const teleportpowerupsABI = [
  {
    "inputs": [
      {
